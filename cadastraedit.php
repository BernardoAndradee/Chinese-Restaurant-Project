...
<head>
    ...
    <title>Restaurante Hào chī: edit</title>
    <style>
            h1,h2
            {
                font-size: 15pt;
...
<div class="main_login">
        <div class="center_login">
            <div class="box">            
                    <form action="cadastrasaveedit.php" method="POST">
                        <fieldset>
                            <legend><h3> Edite o cadastro</h3></legend>
                                ...
                                <br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href ="cadastralistar.php" style ="color: black; font-size: 10pt;">Voltar</a>                        </fieldset>                     
                    </form>           
            </div>
        </div>
    </div>
